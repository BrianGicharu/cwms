...
?>
	...
	<head>
		<title>
			...
			$stmt = $dbh->query($q);
			echo "{$stmt->fetch(PDO::FETCH_COLUMN)} | Admin Dashboard";
			?>
		</title>
							...
							<div class="col-md-3 four-grid">
								<div class="four-wthree">
									...
									<div class="four-text">
										...
										?>
										<h4>
											<?php echo htmlentities($completedbookings); ?>
										</h4>
							...
							<div class="col-md-3 four-grid">
								<div class="four-w3ls">
									...
									<div class="four-text">
										...
										?>
										<h4>
											<?php echo htmlentities($washingpoints); ?>
										</h4>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 four-grid">
								<div class="four-wthree">
									...
									<div class="four-text">
										<h3>Customers</h3>
										<h4>
											<?php echo count(getDistinct('id', 'tblcarwashbooking')[0]); ?>
										</h4>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 four-grid">
								<div class="four-agileinfo">
									...
									<div class="four-text">
										...
										<?php
										$sql1 = "SELECT id from tblcarwashbooking  where paidAmount IS NOT NULL";
										$query1 = $dbh->prepare($sql1);
										$query1->execute();
										$results1 = $query1->fetchAll(PDO::FETCH_OBJ);
										$paidBookings = $query1->rowCount();
										?>
										<h4>
											<?php echo htmlentities($paidBookings); ?>
										</h4>
									</div>
								</div>
							</div>
							...
							<div class="col-md-3 four-grid">
								<div class="four-agileits">
									...
									<div class="four-text">
										...
										<?php
										$sql1 = "SELECT SUM(paidAmount) as amount from tblcarwashbooking  where 1";
										$query1 = $dbh->prepare($sql1);
										$query1->execute();
										...
										?>
										<h4>
											<?php echo "KES " . htmlentities(number_format($results1, 2, ".", ",")); ?>
										</h4>
									</div>
								</div>
							</div>
