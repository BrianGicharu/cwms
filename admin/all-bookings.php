								...
								<tbody>
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {
											$ptype = getRecord("tblwashservice", 'service', $result->packageType); ?>
											<tr>
												...
												<td>
													<?php echo htmlentities($result->washDate . "/" . $result->washTime); ?>
												</td>
												...
												<td>
													<a href="booking-details.php?bid=<?php echo htmlentities($result->bid); ?>&&bookingid=<?php echo htmlentities($result->bookingId); ?>">
														View
													</a>
												</td>
											<?php } ?>
