									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td>
													<a href="editcar-washpoint.php?wpid=<?php echo htmlentities($result->id); ?>">Edit</a> | <a href="managecar-washingpoints.php?rid=<?php echo htmlentities($result->id); ?>" style="color:red;" onClick="return confirm('Do you really want to delete');">Delete</a>
												</td>
											</tr>
									<?php $cnt = $cnt + 1;
										}
